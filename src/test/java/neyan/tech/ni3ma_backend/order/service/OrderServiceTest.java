package neyan.tech.ni3ma_backend.order.service;
...
import neyan.tech.ni3ma_backend.common.config.Ni3maProperties;
...
class OrderServiceTest {
    ...
    @Mock
    private Ni3maProperties ni3maProperties;
    ...
    void setUp() {
        ...
        Ni3maProperties.OrderProperties orderProps = new Ni3maProperties.OrderProperties();
        orderProps.setCancelCutoffMinutes(30);
        orderProps.setPickupCodeLength(6);
        
        Ni3maProperties.BasketProperties basketProps = new Ni3maProperties.BasketProperties();
        basketProps.setMaxQuantityPerOrder(5);

        lenient().when(ni3maProperties.getOrder()).thenReturn(orderProps);
        lenient().when(ni3maProperties.getBasket()).thenReturn(basketProps);
